...
from utils import get_model_file_path

MODEL = get_model_file_path("MobileNetSSD_deploy.caffemodel")
PROTOTXT = get_model_file_path("MobileNetSSD_deploy.prototxt.txt")
